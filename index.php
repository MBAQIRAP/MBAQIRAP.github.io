    ...
    <div class="container">
        <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.php" data-animate-hover="bounce">
                    <img src="logo.png" class="hidden-xs" width="160" height="50">
                    <img src="logo.png" class="visible-xs" width="160" height="50"><span class="sr-only">E-Del - go to homepage</span>
                </a>
        ...
        <div class="same-height-row">
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <h3>Special for Mustika</h3>
                    <p>Aplikasi ini di khususkan untuk informasi delivery makanan di kawasan Mustika Kos.</p>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <p>Aplikasi ini akan memberikan informasi lengkap mengenai menu makanan di warung-warung area Mustika Kos</p>
                </div>
            </div>
        </div>
        <!-- /.row -->
...
<div class="box text-center" data-animate="fadeInUp">
    <div class="container">
        <div class="col-md-12">
            <h3 class="text-uppercase"> Warung Inyong bekerja sama dengan Mustika kos.</h3>
        </div>
    </div>
</div>
